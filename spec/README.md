...
The rrxiv protocol is described in this directory. Each document focuses on a single concern and has a stable filename prefix (`0001-`, `0002-`, …) so it can be referenced from RRPs and code by ID.
...
| [0004](0004-tex-template.md) | `rrxiv.cls` LaTeX template | v0.1 draft |
...
Read [0001-overview.md](0001-overview.md) first if you're new to rrxiv. From there:

- For the **data model**: [0002-cir.md](0002-cir.md) → [0003-claim-graph.md](0003-claim-graph.md).
- For **authoring rrxiv papers**: [0004-tex-template.md](0004-tex-template.md).
