...
- **Read the whitepaper.** Substantive feedback is better than abstract feedback.
- **File issues** for ambiguities, errors, or missing rationale in the whitepaper or schemas.
- **Submit RRPs** for substantive design proposals. See `proposals/README.md`.
- **Implement clients** in other languages. The OpenAPI and JSON Schema specs are the contract.
