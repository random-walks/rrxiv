...
This file lists the active maintainers of the rrvix protocol. It is the canonical source for the "maintainer group" referenced in [`spec/0008-governance.md`](spec/0008-governance.md) and [`proposals/README.md`](proposals/README.md).
...
- **Review and merge PRs** to the canonical `rrvix` repo.
...
- Operate the canonical rrvix.org instance. That role belongs to a separate operating entity (cooperative / nonprofit) per `spec/0008-governance.md` §"Operator vs. protocol".
...
- Summarises the candidate's contribution history to rrvix or adjacent open-source protocols.
...
- Employment by a company whose product or service depends on rrvix's design.
- Equity or other financial interest in such a company.
- Service on the boards of organisations whose interests intersect with rrvix.
